...
public class BookQuantityScheduler {
    ...
    @Scheduled(fixedRateString = "PT03H", initialDelay = 10000)
    private void scheduleCheckQuantity() {
        List<String> isbns = repository.findAll()
                ...
                .map(Book::getIsbn)
                .toList();
        producer.sendMessageToTopic(new BookIsbnMessage(isbns, 500, "library-B-group"));
    }

    @Scheduled(fixedRateString = "PT05H", initialDelay = 10000)
